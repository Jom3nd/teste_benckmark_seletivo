...
class PaymentService:
    def __init__(self,repo=None): self.repo=repo or PaymentRepository(); self.validator=PaymentValidator(); self.audit=AuditService()
    def create(self,i,name,email=""): x=self.validator.validate(Payment(i,name,email)); self.repo.save(x); self.audit.record("create",i); return x
